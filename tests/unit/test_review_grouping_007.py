...
def test_grouping_low_spelling_influence_merges_tokwork_variants() -> None:
    candidates = [
        {"candidate_id": "c1", "extracted_name": "tokwork", "start_timestamp": 10.0},
        {"candidate_id": "c2", "extracted_name": "tikwark", "start_timestamp": 10.5},
    ]
...
def test_grouping_high_temporal_influence_merges_close_ocr_variants_with_strict_spelling() -> None:
    candidates = [
        {"candidate_id": "c1", "extracted_name": "tokwork", "start_timestamp": 10.0},
        {"candidate_id": "c2", "extracted_name": "tikwark", "start_timestamp": 10.5},
    ]
...
def test_grouping_low_spelling_influence_merges_borderline_ocr_pair() -> None:
    candidates = [
        {"candidate_id": "c1", "extracted_name": "johnson", "start_timestamp": 15.0},
        {"candidate_id": "c2", "extracted_name": "j0hxxn", "start_timestamp": 15.0},
    ]
...
def test_grouping_uses_best_in_group_similarity_not_only_anchor_name() -> None:
    candidates = [
        {"candidate_id": "c1", "extracted_name": "johnson", "start_timestamp": 12.0},
        {"candidate_id": "c2", "extracted_name": "johxson", "start_timestamp": 12.3},
        {"candidate_id": "c3", "extracted_name": "j0hxxn", "start_timestamp": 12.6},
    ]
...
def test_grouping_mid_spelling_influence_relaxes_ocr_pair_without_temporal_help() -> None:
    candidates = [
        {"candidate_id": "c1", "extracted_name": "michael", "start_timestamp": 5.0},
        {"candidate_id": "c2", "extracted_name": "mxchxl", "start_timestamp": 205.0},
    ]
    ...
    mid_spelling = GroupingService.build_groups(
        candidates,
        GroupingThresholds(
            similarity_threshold=80,
            temporal_window_seconds=0.0,
    ...
    assert len(strict_spelling) == 2
    assert len(mid_spelling) == 1


def test_grouping_tekwark_tikwark_merge_at_mid_spelling_without_temporal_help() -> None:
    candidates = [
        {"candidate_id": "c1", "extracted_name": "tekwark", "start_timestamp": 12.0},
        {"candidate_id": "c2", "extracted_name": "tikwark", "start_timestamp": 212.0},
    ]
